...
@Component({
    ...
    template: `
        <div class="card">
            ...
            <p class="text-lg mb-4">Apollo is an application template for Angular and is distributed as a CLI project. Current versions is Angular v19 with PrimeNG v19. In case CLI is not installed already, use the command below to set it up.</p>
            <pre class="app-code">
...
ng serve</code></pre>
            ...
            <ul class="leading-normal list-disc pl-8 text-lg mb-4">
                ...
                <li><span class="text-primary font-medium">src/app/pages</span>: Demo pages like Dashboard.</li>
                <li><span class="text-primary font-medium">public/demo/images/landing</span>: Assets used in demos</li>
            ...
            <p class="text-lg mb-4">
                ...
                <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">src/app/layout/core/app.menu.ts</span>
                file. Update the
