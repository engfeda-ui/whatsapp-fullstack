        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxMessagesPerDay = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 100),
                    MaxAiRequests = table.Column<int>(type: "INTEGER", nullable: false),
                    HasAiFeatures = table.Column<bool>(type: "INTEGER", nullable: false),
                    HasMultiAgentSupport = table.Column<bool>(type: "INTEGER", nullable: false),
                    HasSemanticKernel = table.Column<bool>(type: "INTEGER", nullable: false),
                    HasAutoGen = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAiEnhanced = table.Column<bool>(type: "INTEGER", nullable: false),
                    AiInstructions = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevokedByIp = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ReplacedByToken = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CreatedByIp = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    UserId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "TEXT", nullable: false),
                    Type = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "text"),
                    ...
                    AiModel = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Plans",
                columns: new[] { "Id", "CreatedAt", "Description", "HasAiFeatures", "HasAutoGen", "HasMultiAgentSupport", "HasSemanticKernel", "IsActive", "MaxAiRequests", "MaxDevices", "MaxMessagesPerDay", "Name", "Price" },
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Basic plan for testing", false, false, false, false, true, 10, 1, 50, "Free", 0m },
                    { 2, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Perfect for small businesses", true, false, false, true, true, 100, 3, 500, "Starter", 29.99m },
                    { 3, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Advanced features for growing businesses", true, true, false, true, true, 500, 10, 2000, "Professional", 79.99m },
                    { 4, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Full features with multi-agent support", true, true, true, true, true, -1, -1, -1, "Enterprise", 199.99m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_UserId_PhoneNumber",
                table: "Devices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_DeviceId_SentAt",
                table: "Messages",
